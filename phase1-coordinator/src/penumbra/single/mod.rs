...
pub use pphase1::CRSElements as Phase1CRSElements;
pub use pphase1::Contribution as Phase1Contribution;
pub(crate) use pphase1::LinkingProof;
pub use pphase1::RawCRSElements as Phase1RawCRSElements;
pub use pphase1::RawContribution as Phase1RawContribution;

pub use pphase2::CRSElements as Phase2CRSElements;
pub use pphase2::Contribution as Phase2Contribution;
pub use pphase2::RawCRSElements as Phase2RawCRSElements;
pub use pphase2::RawContribution as Phase2RawContribution;
...
pub fn transition(
    phase1: &pphase1::CRSElements,
    circuit: &ConstraintMatrices<F>,
) -> Result<(ExtraTransitionInformation, pphase2::CRSElements)> {
